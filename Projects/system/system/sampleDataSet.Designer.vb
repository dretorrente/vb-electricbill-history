...
Partial Public Class sampleDataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal FirstName As String, ByVal LastName As String, ByVal Phone As String, ByVal Email As String, ByVal Facebook As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, FirstName, LastName, Phone, Email, Facebook}
    ...
    Partial Public Class Table1Row
        ...
        Public Property Facebook() As String
            Get
                Try 
                    Return CType(Me(Me.tableTable1.FacebookColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Facebook' in table 'Table1' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Sub SetFacebookNull()
            Me(Me.tableTable1.FacebookColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace sampleDataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`FirstName`, `LastName`, `Phone`, `Email`, `Facebook`) VALU"& _ 
                "ES (?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `FirstName` = ?, `LastName` = ?, `Phone` = ?, `Email` = ?, `F"& _ 
                "acebook` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstNa"& _ 
                "me` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 A"& _ 
                "ND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Emai"& _ 
                "l` = ?)) AND ((? = 1 AND `Facebook` IS NULL) OR (`Facebook` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApplication1.My.MySettings.Default.sampleConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, FirstName, LastName, Phone, Email, Facebook FROM Table1"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As sampleDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As sampleDataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As sampleDataSet.Table1DataTable = New sampleDataSet.Table1DataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As sampleDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal Original_Phone As String, ByVal Original_Email As String, ByVal Original_Facebook As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FirstName As String, ByVal LastName As String, ByVal Phone As String, ByVal Email As String, ByVal Facebook As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Phone As String, ByVal Email As String, ByVal Facebook As String, ByVal Original_ID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal Original_Phone As String, ByVal Original_Email As String, ByVal Original_Facebook As String) As Integer
            If (FirstName Is Nothing) Then
